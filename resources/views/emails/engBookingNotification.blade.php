        ...
        <td class="container" bgcolor="#FFFFFF">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td>
                            <p>Dear {{$booking->engineer->name}}</p>
                            <p>Please find below the information about a new booking: </p>
                            <ul>
                                <li> Location: {{$booking->location}} </li>
                                <li> Booking Date: {{$bdate}} at {{$booking->booking_time}} </li>
                                <li>Name: {{$booking->name}} </li>
                                <li>Phone: {{$booking->phone}} </li>
                                <li>Address: {{$booking->address}} , {{$booking->town}}, {{$booking->postcode}} </li>
                                <li>Email: {{$booking->email}} </li>
                                <li>Job Detail: {{$booking->notes}} </li>
                            </ul>
        ...
        <td class="container">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td align="center">
                        <p>Computer Gurus Limited registered office is 39 Blackthorn Avenue, Tunbridge Wells, TN4 9YD, UNITED KINGDOM Registration No 5142185 
