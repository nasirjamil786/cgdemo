...
<html lang="en">
   <head>
       <title>Your Device Has Been Fixed</title>
    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <header>
            ...
            <h1 style="color: #000000; font-size: 20px; font-weight: 500; line-height: 20px; margin: 48px 0; text-align: center;">
                Please Review us
            </h1>
        </header>
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <p>
                  We greatly value your opinion and would appreciate it 
                  if you could take a moment to share your feedback by writing a review on Google.
                </p>
                <p>
                  Please click this link for Google review: <a href="https://g.page/r/CXQR4M1vHXoHEBE/review">https://g.page/r/CXQR4M1vHXoHEBE/review </a> 
                </p>

                <p>Please call us 01892 529999 If you have any question.</p>
                
                <p> Thank you</p>
                <p> Farah Nasir (Director)</p>
                <p> Computer Gurus Limited</p>
                <!--[if (gte mso 9)|(IE)]>
                </td></tr></table>
                <![endif]-->
            </div>
        ...
        <footer>
            ...
            <p style="font-size: 16px; font-weight: 400; line-height: 24px; margin-top: 48px;">
                You received this email because you gave us a verbal permission to send you emails about feedbacks. If you wish to unsubscribe please reply to this email with UNSUBSCRIBE subject.
            </p>
