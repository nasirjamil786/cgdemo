    ...
    <div role="article" aria-label="An email from Your Brand Name" lang="en" style="background-color: white; color: #2b2b2b; font-family: 'Avenir Next', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; font-size: 18px; font-weight: 400; line-height: 28px; margin: 0 auto; max-width: 600px; padding: 40px 20px 40px 20px;">
        ...
        <main>
            ...
            <div style="background-color: ghostwhite; border-radius: 4px; padding: 24px 48px;">
                ...
                <!-- Body copy -->
                <p> Dear {{$order->customer->first_name}} {{$order->customer->last_name}} 
                </p>
                <p>We hope this message finds you well.</p>
                <p>
                We're pleased to inform you that we have successfully placed the order for the 
                required parts for your <strong>{{$order->make->make}} {{$order->model}}</strong>. 
                The process is underway, and we anticipate receiving the parts shortly.
                </p>
                <p>
                    Once the parts arrive, we'll promptly proceed with the necessary work and keep you updated on the 
                    progress every step of the way.
                </p>
                <p>
                    Thank you for your patience and trust in our services. If you have any further questions or concerns, 
