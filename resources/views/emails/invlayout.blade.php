...
<html>
<head>
<title>Computer Gurus Invoice</title>
<!--
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="47%" style="width: 47%;" align="left">
                                        <tr>
                                            <td style="padding: 0 0 10px 0;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td align="left" style="font-family: Arial, sans-serif; color: #333333; font-size: 16px;">{{$pay->payment_type}} made on {{$pay->payment_date}}
                                                               by {{$pay->payment_method}} @if($pay->payment_ref != NULL) 
