                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{url('customer')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input  type="text" class="form-control" name="recommended_name" id="recommended_name" value="{{ old('recommended_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" rows="4" name="notes" id="notes" placeholder="Notes">
                                        {{ old('notes') }}
                                    </textarea>
                                </div>
                            </div>
